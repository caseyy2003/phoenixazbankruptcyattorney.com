...
export default function HeaderLinks(props) {
  ...
  const smoothScroll = (e, target) => {
    if (window.location.pathname === "/sections") {
      ...
      if (isMobile) {
        // On mobile devices, the scroll is managed by the browser.
      } else {
        e.preventDefault();
    ...
    <List className={classes.list + " " + classes.mlAuto}>
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          buttonIcon={Apps}
          dropdownList={[
            <Link href="/presentation" key="presentation">
              <a className={classes.dropdownLink}>
                <LineStyle className={classes.dropdownIcons} /> Presentation
                Page
              </a>
            </Link>,
            <Link href="/components" key="components">
              <a className={classes.dropdownLink}>
      ...
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          buttonIcon={ViewDay}
          dropdownList={[
            <Link href="/sections#headers" key="headers">
              <a
                className={classes.dropdownLink}
            ...
            <Link href="/sections#features" key="features">
              <a
                className={classes.dropdownLink}
            ...
            <Link href="/sections#blogs" key="blogs">
              <a
                className={classes.dropdownLink}
            ...
            <Link href="/sections#teams" key="teams">
              <a
                className={classes.dropdownLink}
            ...
            <Link href="/sections#projects" key="projects">
              <a
                className={classes.dropdownLink}
            ...
            <Link href="/sections#pricing" key="pricing">
              <a
                className={classes.dropdownLink}
            ...
            <Link href="/sections#testimonials" key="testimonials">
              <a
                className={classes.dropdownLink}
            ...
            <Link href="/sections#contacts" key="contacts">
              <a
                className={classes.dropdownLink}
      ...
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          dropdownList={[
            ...
            <Link href="/landing-page" key="landing-page">
              <a className={classes.dropdownLink}>
            ...
            <Link href="/shopping-cart" key="shopping-cart">
              <a className={classes.dropdownLink}>
                <ShoppingBasket className={classes.dropdownIcons} /> Shopping Cart
              </a>
            </Link>,
            <Link href="/ecommerce" key="ecommerce">
              <a className={classes.dropdownLink}>
            ...
            <Link href="/error-page" key="error-page">
              <a className={classes.dropdownLink}>
