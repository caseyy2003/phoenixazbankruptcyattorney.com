...
import TermsAndConditions from "../../content/TermsAndConditions.js";
import AzAreas from "/components/AzAreas/AzAreas.js";

const HEADER_HEIGHT = 52;

const PAGE_URL = "https://www.phoenixazbankruptcyattorney.com/terms-and-conditions";
...
export default function Terms() {
  return (
    <PerfPageLayout
      title="Terms and Conditions | Yontz Law, PLLC"
      description="Read the Terms and Conditions for using the Yontz Law, PLLC website."
      canonical={PAGE_URL}
      hero={{
        srcWebp: HERO_WEBP,
        srcJpg: HERO_JPG,
        ...
        height: 600,
        alt:
          "Wide hero background image for the Yontz Law, PLLC Terms and Conditions page.",
        priority: true,
        cta: <HeroCtaWithLogo />,
      }}
    >
