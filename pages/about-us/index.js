...
const PAGE_URL = "https://www.phoenixazbankruptcyattorney.com/about-us";
...
export default function AboutUsPage() {
  return (
    <PerfPageLayout
      title="About Us | Yontz Law, PLLC"
      description="Learn about Yontz Law, PLLC and our approach to helping Arizona residents with bankruptcy options."
      canonical={PAGE_URL}
      hero={{
        srcWebp: HERO_WEBP,
        srcJpg: HERO_JPG,
        width: 900,
        height: 600,
        alt: "Wide hero image for the Yontz Law, PLLC About Us page.",
        priority: true,
        cta: <HeroCtaWithLogo />,
      }}
    >
